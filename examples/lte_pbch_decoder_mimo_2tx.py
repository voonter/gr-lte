...
class lte_pbch_decoder_mimo_2tx(gr.hier_block2):
    def __init__(self, N_rb_dl=50, rxant=2):
        gr.hier_block2.__init__(
            self, "PBCH Decoder MIMO 2TX",
                gr.io_signature.makev(3, 3, [gr.sizeof_gr_complex*12*N_rb_dl*rxant, gr.sizeof_gr_complex*12*N_rb_dl*rxant, gr.sizeof_gr_complex*12*N_rb_dl*rxant]),
        ...
        self.connect((self.lte_pbch_demux_vcvc_0_0, 0), (self.lte_pre_decoder_vcvc_0_0, 2))
        self.connect((self.lte_pbch_demux_vcvc_0_1, 0), (self.lte_pre_decoder_vcvc_0, 1))
        self.connect((self.lte_pbch_demux_vcvc_0_1, 0), (self.lte_pre_decoder_vcvc_0_0, 1))
